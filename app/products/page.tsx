...
//with deal color with cart local storage without rtdb
...
//   // ✅ Check if product is in cart - Firebase sync ke saath
//   const isProductInCart = (productId: string) => {
//     if (!user) return false; // ✅ User not logged in = no cart
//     if (cartLoading) return false; // ✅ Loading state
//     return cartItems.some((item) => item.id === productId);
//   };
...
//                 className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl leading-relaxed"
//               >
//                 Discover our handpicked selection of premium perfumes, luxurious
//                 wax collections, and skincare essentials. Each product is
//                 curated for quality and elegance.
//               </motion.p>
//             </motion.div>
...
//                 {stockAlert} is currently out of stock
//               </p>
//             </div>
//           </motion.div>
//         )}
...
//                               <div className="relative">
//                                 <div
//                                   className="text-white text-[8px] sm:text-[10px] md:text-xs font-bold 
//           px-1.5 sm:px-2 md:px-3 
//           py-1.5 sm:py-1 md:py-1.5 
//           min-[450px]:py-0.5
//           rounded-lg shadow-lg flex items-center justify-center gap-0.5 sm:gap-1 mx-auto w-full border-2 border-white/30 animate-pulse"
//                                   style={{ backgroundColor: dealColor }}
//                                 >
//                                   <span className="text-[6px] sm:text-[8px] md:text-[10px]">
//                                     🔥
//                                   </span>
//                                   <span className="truncate font-bold tracking-wide max-[450px]:text-[10px] sm:text-[9px] md:text-xs">
//                                     {product.dealName}
//                                   </span>
//                                   <span className="text-[6px] sm:text-[8px] md:text-[10px]">
//                                     🔥
...
//                             <div className="absolute bottom-2 left-2 bg-blue-500/90 text-white text-[8px] sm:text-xs px-2 sm:px-3 py-0.5 sm:py-1 rounded-full font-semibold shadow-lg flex items-center gap-1">
//                               <span>
//                                 {product.flavors?.length || 0} Variants
//                               </span>
//                             </div>
//                           )}
...
//                           <div
//                             className={`inline-flex items-center gap-1 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-[10px] sm:text-xs font-semibold ${stockStatus.color}`}
//                           >
//                             {isOutOfStock ? (
//                               <AlertCircle
//                                 size={12}
...
//                   <Filter
//                     size={36}
//                     className="sm:w-[48px] sm:h-[48px] text-gray-400 mx-auto opacity-30"
//                   />
//                 </motion.div>
...
//with toast duration 1 sec with logged out scene
...
//               initial={{ width: "100%" }}
//               animate={{ width: "0%" }}
//               transition={{ duration: 1, ease: "linear" }} // ✅ 1 second
//               className="h-full bg-green-500 rounded-full"
//             />
//           </div>
//         </div>
...
export default function ProductsPage() {
  ...
  // ✅ Check if product is in cart - Guest support (no login required)
  const isProductInCart = (productId: string) => {
