...
//with deal box height with cart local storage without cart rtdb 
...
// }
  ...
  // import { motion, AnimatePresence } from "framer-motion";
  // import Link from "next/link";
  // import { ArrowRight, CheckCircle, Sparkles, ShoppingCart, X } from "lucide-react";
  // import { rtdb } from "@/lib/firebase";
  // import { ref, onValue } from "firebase/database";
  // import Navbar from "@/components/Navbar";
  // import { CartItem, useCart } from "@/lib/cartContext";
  ...
  //without login scene and with banner img bg
...
//   // ✅ Check if product is in cart - Guest support
//   const isProductInCart = (productId: string) => {
...
//         {/* Hero Banner */}
//         <section className="relative w-full h-[calc(100vh-64px)] max-h-[600px] overflow-hidden bg-black">
//           {/* Desktop Background */}
//           <motion.div
//             initial={{ scale: 1.1, opacity: 0 }}
//             animate={{ scale: 1, opacity: 1 }}
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      {/* Main Content */}
      <div className="relative z-10">
        {/* Hero Banner - WITHOUT WATERMARK */}
        <section className="relative w-full h-[calc(100vh-64px)] max-h-[600px] overflow-hidden bg-black">
          {/* ✅ Desktop Background - ONLY on desktop */}
          {!isMobile && (
            <motion.div
              initial={{ scale: 1.1, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
          ...
          {isMobile && mobileImages.length > 0 && imagesLoaded && (
          ...
          {/* ✅ Fallback for mobile - if no mobile images */}
          {isMobile && (mobileImages.length === 0 || !imagesLoaded) && (
            <motion.div
              initial={{ scale: 1.1, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
        ...
        {/* Featured Products - WITH WATERMARK ONLY HERE */}
        <section className="py-12 sm:py-16 px-4 relative bg-white overflow-hidden">
          {/* ✅ Watermark - ONLY in products section */}
