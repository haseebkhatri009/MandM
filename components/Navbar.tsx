...
//                     <Link 
//                       href="/admin" 
//                       className="px-4 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-300 font-medium flex items-center justify-center"
//                       onClick={() => setMobileMenuOpen(false)}
//                     >
//                       Admin Dashboard
//                     </Link>
...
//           // First time loading, don't show notifications for existing orders
...
//   // ✅ Mark as seen when admin visits admin page
//   useEffect(() => {
...
//                 >
//                   Admin
//                   {/* ✅ Notification Dot - shows only if unseen orders exist */}
//                   {newOrderCount > 0 && (
//                     <motion.span 
//                       initial={{ scale: 0 }}
//                       animate={{ scale: 1 }}
...
//         // ✅ Count only unread messages (not admin messages)
...
//         // ✅ Save total messages count for seen tracking
...
import { useAuth } from '@/lib/authContext';
import { useCart } from '@/lib/cartContext';
import { ShoppingCart, Menu, X, Package, Shield, Info, Phone, Home } from 'lucide-react';
import { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col p-4 space-y-1">
                ...
                <Link 
                  href="/" 
                  className="px-4 py-3 hover:bg-gray-50 rounded-lg transition-all duration-300 text-gray-700 font-medium flex items-center gap-3"
                  onClick={() => setMobileMenuOpen(false)}
                >
                ...
                <Link 
                  href="/cart" 
                  className="px-4 py-3 hover:bg-gray-50 rounded-lg transition-all duration-300 text-gray-700 font-medium flex items-center justify-between gap-3"
                  onClick={() => setMobileMenuOpen(false)}
                >
